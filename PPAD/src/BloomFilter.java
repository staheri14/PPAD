...
import java.util.Collection;
    ...
    public class BloomFilter<E> implements Serializable {
        ...
        static final String hashName = "SHA1"; // MD5 gives good enough accuracy in most circumstances. Change to SHA1 if it's needed
        ...
        /**
         * displays bloom filter
         * @param
         */
        public  void  display()
        {
            for(int i=0;i<getBitSet().size();i++)
            {
                if(getBitSet().get(i))
                    System.out.print("1, ");
                else
